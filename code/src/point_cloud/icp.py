...
class ICP:
    def __init__(self, source, target, threshold=0.02, type = 'point_to_point', initial_transformation = None):
        self.source = source
        self.target = target
        self.threshold = threshold
        self.type = type
        self.initial_transformation = initial_transformation if initial_transformation is not None else np.identity(4)
